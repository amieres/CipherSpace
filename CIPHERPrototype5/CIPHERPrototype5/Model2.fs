...
//        | CPClientForm
//        | CPUserForm
        | CPNode      of content:string * code:string
        | CPItem      of    name:string
        | CPLogout
        | CPHomePage
        | CPUploadForm

    type EndPoint =
        | [< WebSharper.Sitelets.EndPoint "/" >] EPEntry
        | EPHome
        | EPItem    of name:string
        | EPContent of ContentPage
        | EPLogout
        | [<WebSharper.Sitelets.Wildcard      >] EPFile       of filename:string
        | [<WebSharper.Sitelets.Wildcard      >] EPJavaScript of filename:string        
...
//    let getJVSProp obj prop = null
    ...
    let call f this p1 = WebSharper.JavaScript.Interop.X<_>
