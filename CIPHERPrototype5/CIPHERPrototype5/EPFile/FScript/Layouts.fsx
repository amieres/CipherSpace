#r @"D:\Abe\CIPHERWorkspace\CipherSpace\CIPHERPrototype5\CIPHERPrototype5\bin\CIPHERPrototype5.dll"
#r @"D:\Abe\CIPHERWorkspace\CipherSpace\CIPHERPrototype5\CIPHERPrototype5\bin\WebSharper.Main.dll"
#r @"D:\Abe\CIPHERWorkspace\CipherSpace\CIPHERPrototype5\CIPHERPrototype5\bin\WebSharper.Core.dll"
#r @"D:\Abe\CIPHERWorkspace\CipherSpace\CIPHERPrototype5\CIPHERPrototype5\bin\WebSharper.Collections.dll"
#r @"D:\Abe\CIPHERWorkspace\CipherSpace\CIPHERPrototype5\CIPHERPrototype5\bin\WebSharper.JavaScript.dll"
...
[< Require(typeof<ReactLoader    >)
 ; Require(typeof<JQueryLoader   >)
 ; Require(typeof<BootstrapLoader>)
 ; Require(typeof<MainCssLoader  >)
 ; JavaScript                    >]
module DataTube =
...
module ListRender =
    ...
    let view (props: Props) (model: Model) (processMessages: Message -> unit) =
        let toString       = props.toString   |> Option.defaultValue (sprintf "%A")
        let layout         = props.layout     |> Option.defaultValue (fun (_, _, nodes) -> Ul nodes)
        let itemLayout     = props.itemLayout |> Option.defaultValue (ItemRender.next2 None None)
