...
module AboutForm =
    ...
    let createForm_ initial (container: Element) =

        let renderForm (state: obj) (setState: obj -> unit) =
            R.E("div", Attrs(className = "col-md-6")
              , R.E("a", Attrs(href = "emails.html")
                  , R.E("img", Attrs(src = "/EPFile/image/inky-template.svg"))
                  , R.E("h6", Attrs()
                      , R.t "Foundation for")
                  , R.E("h2", Attrs()
                      , R.t "Emails")
                  , R.E("p", Attrs()
                      , R.t "Our email framework helps you craft responsive HTML emails that can be read anywhere on any device. Foundation for Emails helps navigate the how different email clients handle HTML and provide tested patterns that work with Outlook as well as all the other major email clients.")
                  , R.E("p", Attrs(className = "link")
                      , R.t "Learn more about Foundation for Emails")))
